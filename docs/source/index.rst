.. PixelCraft documentation master file, created by
...
===============================
PixelCraft automates the boring, error prone task of videos key/best frames extraction,
video compression and manual time consuming task of image cropping.
In summary you should consider using PixelCraft library if you have following tasks which you 
want to automate:
...
#. You have video/videos from who you want to extract keyframe/keyframes. 
   ...
   Take an example of this video and some of the top keyframes extracted using PixelCraft. 
   ...
   .. figure:: images/keyframe_extraction.jpg
         :width: 100%
         :align: center
         :alt: Image of keyframe extracted using PixelCraft
...
#. You have image/images which you want to smartly resize to a target resolution.
   ...
   .. figure:: images/pixelcraft_image_resize.jpg
         :width: 100%
         :align: center
         :alt: PixelCraft Image resize
...
#. You have image/images from which you want to intelligently extract a crop with a target resolution.
   ...
   .. figure:: images/pixelcraft_image_crop.jpg
      :width: 100%
      :align: center
      :alt: PixelCraft Image crop
...
PixelCraft is divided into two modules namely video and image module.
...
read in :ref:`PixelCraft.video_compressor` section.

Since version 0.8.0 of PixelCraft we are extending smart resize features to videos
...
:ref:`PixelCraft.video_resize`. Please note that this feature is an 
...
and `configure <https://google.github.io/mediapipe/solutions/autoflip.html>`_ mediapipe to be used with pixelcraft. 
...
Similar to Smart crop PixelCraft image module supports **Smart image resizing** feature.
...
**Please not that if aspect ratio of input and output image are not same pixelcraft image_resize can lead to some loss of image content**
...
.. toctree::
   ...
   Understanding pixelcraft <understanding_pixelcraft>
