...
class TextDetector:
    ...
    # Download Link for Text detection model (multiple backup sources)
    ...
    # Primary download link for backward compatibility
    model_download_link = "https://github.com/ZER-0-NE/EAST-Detector-for-text-detection-using-OpenCV/raw/master/frozen_east_text_detection.pb"
