...
class Writer:
    ...
    def write(self, filepath, data):
        ...
        :type filepath: str
        :param data: Data generated by PixelCraft library for the file @ filepath
        :type data: list
        """
        pass
...
class KeyFrameDiskWriter(Writer):
    ...
    def write(self, filepath, data):
        """Write the data generated by PixelCraft library for file @ filepath on to the disk.

        :param filepath: path of the input file processed by PixelCraft
        :type filepath: str
        :param data: data generated using PixelCraft library
        :type data: list
        """
